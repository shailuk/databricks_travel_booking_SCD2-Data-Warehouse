...
CREATE SCHEMA IF NOT EXISTS nsk_travel_booking_project_2.analytics;
CREATE SCHEMA IF NOT EXISTS nsk_travel_booking_project_2.ops;
...
CREATE TABLE IF NOT EXISTS nsk_travel_booking_project_2.ops.workflow2_run_log (
   run_id STRING,
   arrival_date DATE,
   status STRING,
   message STRING,
