...
CREATE TABLE IF NOT EXISTS nsk_travel_booking_project_2.ops.dq_daily_summary (
  business_date DATE,
  dataset STRING,
  checks_passed INT,
  checks_failed INT,
...
MERGE INTO nsk_travel_booking_project_2.ops.dq_daily_summary t
USING (
  SELECT
  ...
  FROM nsk_travel_booking_project_2.ops.dq_results
