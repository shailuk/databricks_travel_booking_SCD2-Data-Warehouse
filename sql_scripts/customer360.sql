...
CREATE OR REPLACE VIEW nsk_travel_booking_project_2.analytics.customer_360 AS
SELECT
...
FROM nsk_travel_booking_project_2.default.customer_dim d
JOIN nsk_travel_booking_project_2.default.booking_fact f
